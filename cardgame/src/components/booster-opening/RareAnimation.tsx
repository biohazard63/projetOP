...
export default function UltraRareAnimation({ card, onComplete, performanceMode = false }: Readonly<UltraRareAnimationProps>) {
  ...
  useEffect(() => {
    ...
    const duration = performanceMode ? 2500 : 3000
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            >
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-full font-bold shadow-lg">
            ...
            >
              ...
              >
                <Sparkles className={`${isMobile ? 'w-6 h-6' : 'w-8 h-8'} text-blue-400`} />
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <p className={`${isMobile ? 'text-sm' : 'text-base'} text-blue-300 mt-1`}>
                {card.type}
              </p>
            </motion.div>
          </div>
