  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-emerald-500/20 to-blue-500/20"
          animate={{
        ...
        >
          <div className="relative">
            ...
            <motion.div
              className="absolute -inset-4 bg-gradient-to-r from-emerald-400 to-blue-500 rounded-xl blur-xl"
              animate={{
                opacity: [0.5, 0.8, 0.5],
                scale: [1, 1.1, 1]
              }}
            ...
            {/* Effet de halo */}
            <motion.div
              className="absolute -inset-8 bg-gradient-to-r from-emerald-400/30 to-blue-500/30 rounded-xl blur-2xl"
              animate={{
                opacity: [0.3, 0.5, 0.3],
                scale: [1, 1.2, 1]
              }}
            ...
            {/* Texte "ALTERNATIVE" */}
            <motion.div
              className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-emerald-400 to-blue-500 text-white px-4 py-2 rounded-full font-bold text-lg shadow-lg"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              ...
              <p className="text-lg text-emerald-400 mt-1">{card.type}</p>
            </motion.div>
          </div>
        </motion.div>
