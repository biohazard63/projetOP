...
export default function UltraRareAnimation({ card, onComplete, shouldPlaySound = false, performanceMode = false }: Readonly<UltraRareAnimationProps>) {
  ...
  const { playUltraRareSound, shouldPlaySound: canPlaySound } = useAudio()
  ...
  useEffect(() => {
    ...
    const duration = performanceMode ? 1800 : 2200
  ...
  }, [onComplete, playUltraRareSound, shouldPlaySound, performanceMode])
      ...
      {isVisible && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center">
            ...
            >
              <div className="bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-4 py-2 rounded-full font-bold shadow-lg">
            ...
            >
              ...
              <motion.div
                className="absolute -inset-2 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-xl blur-md"
                animate={{
                  opacity: [0.3, 0.6, 0.3]
                }}
                transition={{
              ...
              >
                <Sparkles className={`${isMobile ? 'w-6 h-6' : 'w-8 h-8'} text-yellow-400`} />
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <p className={`${isMobile ? 'text-sm' : 'text-base'} text-yellow-300 mt-1`}>
                {card.type}
              </p>
            </motion.div>
          </div>
